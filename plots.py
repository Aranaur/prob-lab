...
# Re-export theme symbols for backward compatibility
from theme import (                           # noqa: F401
    _TRANSPARENT, _GRID, _AXIS, _LABEL,
    _LIGHT_GRID, _LIGHT_AXIS, _LIGHT_LABEL,
    _DARK_LAYOUT, _LIGHT_LAYOUT, _CONFIG,
    _theme, _base_fig,
)
